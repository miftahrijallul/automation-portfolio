...
Small, tested Python tools for document and data automation.
...
Technical staff for two university journals at Universitas Padjadjaran — I handle document production, layout (LaTeX), and publishing systems (OJS) daily. These tools are extracted from real workflow automation.
